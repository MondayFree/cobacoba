...
//     if( el.target.classList.item(0) == 'tombol' ) {
//         if( el.target.classList.item(1) != 'clear' && el.target.classList.item(1) != 'hapus' && el.target.classList.item(1) != 'samadengan' && el.target.classList.item(1) != 'perluas' ) {
//             if( el.target.classList.item(1) != 'tambah' && el.target.classList.item(1) != 'kurang' && el.target.classList.item(1) != 'kali' && el.target.classList.item(1) != 'bagi' ) {
//                 const pSemua = rata.getElementsByTagName('p');
//                 const pAkhir = pSemua[pSemua.length - 1];
//                 const angka = document.createTextNode(el.target.classList.item(2));
//                 pAkhir.appendChild(angka);
//             } else if( el.target.classList.item(1) == 'tambah' || el.target.classList.item(1) == 'kurang' || el.target.classList.item(1) == 'kali' || el.target.classList.item(1) == 'bagi' ) {
//                 const pBaru = document.createElement('p');
//                 const operator = document.createTextNode(el.target.classList.item(2));
//                 pBaru.appendChild(operator);
//                 rata.appendChild(pBaru);
//                 const pBLagi = document.createElement('p');
//                 rata.appendChild(pBLagi);
//             }
//         }
//     }
// });
...
//     const terakhir = rata.lastElementChild;
//     if( terakhir.childNodes.length == 0 || terakhir.childNodes.length == 1 ) {
//         rata.removeChild(terakhir);
//     }
// });